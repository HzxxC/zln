...
(39, 0, 'Admin', 'Extension', 'default', '', 0, 1, '扩展工具', 'cloud', '', 50),
(40, 39, 'Admin', 'Backup', 'default', '', 1, 1, '备份管理', '', '', 4),
...
(109, 0, 'Admin', 'Setting', 'default', '', 0, 1, '网站配置', 'cogs', '', 0),
(110, 109, 'Admin', 'Setting', 'userdefault', '', 0, 1, '个人信息', '', '', 1),
...
(132, 0, 'User', 'Indexadmin', 'default', '', 1, 0, '用户管理', '', '', 10),
...
(139, 0, 'User', 'Indexadmin', 'default3', '', 1, 1, '管理员', 'group', '', 40),
